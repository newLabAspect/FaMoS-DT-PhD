...
variedMetricSteps = linspace(0.0005,0.00005,10);

%% Actual execution
allData = 1:10;
evalData = [2,8];

[correct,false,t_cluster,t_train,trace] = evalMain(allData,evalData,['ExampleSystems', filesep, 'TwoStateHybridAutomaton']);