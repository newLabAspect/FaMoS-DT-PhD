...
variedMetricSteps = linspace(0.005,0.000005,100);

%% Actual execution
allData = 1:6;
evalData = [2,6];

[correct,false,t_cluster,t_train,trace,ClusterCorrect,ClusterFalse] = evalMain(allData,evalData,['ExampleSystems', filesep, 'ThreeStateHybridAutomaton']);