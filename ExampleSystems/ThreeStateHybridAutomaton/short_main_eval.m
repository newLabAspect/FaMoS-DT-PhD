...
thresClusterMax = 0.1; thresClusterMin = 0.01; offsetCluster = 1; facThres = 2.5;
...
[correct,false,t_cluster,t_train,trace] = evalMain(allData,evalData,['ExampleSystems', filesep, 'ThreeStateHybridAutomaton']);