...
global sigma winlen
sigma = 0.00000001;  winlen=1; % LMI paras
...
% Slightly off paras
%thresClusterMax = 1; thresClusterMin = 0.001; facThres = 2.5;
...
[correct,false,t_cluster,t_train,trace,ClusterCorrect,ClusterFalse,pred_trace,confDeg] = traceMain(allData,evalData,['ExampleSystems', filesep, 'MultiRoomHeatingSystem']);