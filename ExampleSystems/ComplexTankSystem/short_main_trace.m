...
global sigma winlen
sigma = 0.00000004;  winlen=1; % LMI paras
...
% Slightly off paras
%thresClusterMax = 1; thresClusterMin = 0.0001; facThres = 2.5;
...
variedMetricSteps = linspace(0.52,0.52,1); %errors in range 0.7...0.8
