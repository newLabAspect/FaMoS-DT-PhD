...
addpath(['HAutLearn', filesep, 'example', filesep, '1_boiler_system', filesep, 'trainingdata_boiler']);
...
FnGenerateHyst(['HAutLearn', filesep, 'example', filesep, '1_boiler_system', filesep, 'automata_learning'],label_guard, num_var, ode, pta_trace);

addpath(['HAutLearn', filesep, 'src',filesep,'hyst', filesep, 'src', filesep, 'matlab']);

try
    SpaceExToStateflow(['HAutLearn', filesep, 'example', filesep, '1_boiler_system', filesep, 'automata_learning.xml']);
catch
