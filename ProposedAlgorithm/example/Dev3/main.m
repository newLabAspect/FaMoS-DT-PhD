...
addpath(['ProposedAlgorithm', filesep, 'example', filesep, 'Dev3']);
...
sigma = 0.01;  winlen=5; thresClusterMax = 1; thresClusterMin = 0.01; offsetCluster = 1; facThres = 2.5; %used in clustering
